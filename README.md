...
- [2.7 Reading Forecast Files Using ecCodes](#27-reading-forecast-files-using-eccodes)
...
### 2.5 Retrieving Forecasts via REST API
...
#### 2.5.1 Submitting a POST Request
...
#### 2.5.2 Downloading the Forecast Data
...
#### 2.6.1 Accessing Vertical Grid Parameters
...
#### 2.6.2 Accessing Horizontal Grid Parameters
...
### 2.7 Reading Forecast Files Using ecCodes
...
#### 2.7.1 Installing ecCodes and COSMO definitions
